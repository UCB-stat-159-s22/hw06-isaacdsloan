...
utils.plot_matched_filtering(template_p, template_c, 
template_offset, time, strain_L1, strain_H1, 
strain_L1_whitenbp, strain_H1_whitenbp, dt, ab, 
bb, normalization, 
make_plots, tevent = 1126259462.44, 
plottype = "png",fs = 4096, eventname = 'GW150914')
...
headcsv = "data/" +eventname+' time-'+str(tevent)+     ' (s),H1_data_whitened,L1_data_whitened,H1_template_whitened,L1_template_whitened'
fmtcsv = ",".join(["%10.6f"] * 5)
